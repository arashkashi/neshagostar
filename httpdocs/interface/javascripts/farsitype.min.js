		...
		if (FarsiType.Type) {
			...
			if (key>128){
				if (FarsiType.KeyBoardError == 0) {
					...
					alert("لطفا زبان صفحه ی کلید خود را در سیستم عامل ویندوز به انگلیسی تغییر دهید.");
					return false;
				};
			};
			...
			if (z.farsi && key > 31 && key < 128) {
				...
				if ( (key >= 65 && key <= 90) && !e.shiftKey ) {
					alert("Caps Lock فعال است. لطفا برای عملکرد درست سیستم تایپ فارسی، این دکمه را غیر فعال نمایید..");
					return false;
				}
