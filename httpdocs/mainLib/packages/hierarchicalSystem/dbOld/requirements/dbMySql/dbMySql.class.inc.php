<?php
/**
* $Id: dbMySql.class.inc.php 184 2008-10-23 07:58:31Z sinasalek $
*
...
*/
// previous name : db
class cmfcHierarchicalSystemDbTreeDb {
    /**
    * Database connection
    *
    * @var resource
    ...
    * @return db object
    */
    function cmfcHierarchicalSystemDbTreeDb($host, $user, $password, $database) {
    ...
    */
    function Execute($sql) {
        ...
        $recordset = new cmfcHierarchicalSystemDbTreeDbRecordset($res, $sql);
        return $recordset;
    }
...
// previous name : recordset
class cmfcHierarchicalSystemDbTreeDbRecordset {
    /**
    * Recordset resource.
    *
    * @var resource
    ...
    */
    function cmfcHierarchicalSystemDbTreeDbRecordset($recordset, $sql) {
